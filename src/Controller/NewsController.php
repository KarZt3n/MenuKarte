...
class NewsController extends AbstractController
{
    ...
    /**
     * @Route("/{slug}", name="app_news_showNews", methods={"GET"})
     */
    public function showNews($slug): Response
    {
        $em = $this->doctrine->getManager();

        $news = $em->getRepository(News::class)->findOneBy(array('slug' => $slug));

        if (!$news){
            return $this->render('news/notFound.html.twig');
        }
